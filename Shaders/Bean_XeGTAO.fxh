...
#define BEAN_CLIP_FAR (1000.0f)
#define BEAN_CLIP_NEAR (1.0f)
    ...
    float ScreenSpaceToViewSpaceDepth(float depth) {
        float depthLinearizeMul = (BEAN_CLIP_FAR * BEAN_CLIP_NEAR) / (BEAN_CLIP_FAR - BEAN_CLIP_NEAR);
        float depthLinearizeAdd = BEAN_CLIP_FAR / (BEAN_CLIP_FAR - BEAN_CLIP_NEAR);
